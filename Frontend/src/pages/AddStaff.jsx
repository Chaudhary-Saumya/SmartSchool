...
export default function AddStaff() {
  const [activePage, setActivePage] = useState("add-staff"); // eslint-disable-line no-unused-vars
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="flex items-center text-sm text-gray-500 mb-6 space-x-2">
            <span className="font-semibold text-gray-800">Add Staff</span>
            <span>›</span>
            <span>Staff</span>
            <span>›</span>
            <span className="text-gray-800 font-medium">Add Staff</span>
          </div>
