...
export default function AddStudent() {
  const [activePage, setActivePage] = useState("add-student"); // eslint-disable-line no-unused-vars
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(data.message || `Failed to create student account (${response.status})`);
      }
    } catch (error) {
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="flex items-center text-sm text-gray-500 mb-6 space-x-2">
            <span className="font-semibold text-gray-800">Add Students</span>
            <span>›</span>
            <span>Teacher</span>
            <span>›</span>
            <span className="text-gray-800 font-medium">Add Students</span>
          </div>
