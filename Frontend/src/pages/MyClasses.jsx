...
export default function MyClasses() {
  const [activePage, setActivePage] = useState("my-classes"); // eslint-disable-line no-unused-vars
  const myClasses = [
    {
      className: 'Class 1A',
      subject: 'Mathematics',
              ...
              <table className="min-w-full text-sm whitespace-nowrap">
                <thead className="bg-gray-100 text-gray-600 uppercase text-xs">
                  <tr>
                    ...
                    <th className="p-3 text-left w-28">Time</th>
                ...
                <tbody>
                  {myClasses.map((item, i) => (
                    <tr key={i} className="border-b hover:bg-gray-50">
                      ...
                      <td className="p-3 text-gray-800 font-medium">{item.className}</td>
